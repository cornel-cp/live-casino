...
const Acadamy = () => {
    ...
    return (
        <div className="flex-4 group border-1 border-white/20 m-1 text-center py-6 hover:border-red-600 transition duration-1000">
            ...
            <p className="nunito text-[16px] md:text-[14px] md:min-h-[200px] lg:min-h-[130px]">Baccarat Gold 1.0 is played around the world
                and is one of the most popular games at
                Casino M8trix. Known for its simplicity,
                the objective of Baccarat Gold 1.0 is to get
                closest to the point value of 9 by betting on
                either the Player or Banker hand. Introducing
                bonus options that pay up to $2,000!</p>
