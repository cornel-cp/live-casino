...
const Footer = () => {
  ...
  return (
    <footer className="">
      ...
      <div className="nunito bg-[url(/assets/images/footer-bg2.png)] bg-black bg-no-repeat bg-cover bg-center pb-10">
        <div className="bg-linear-to-b from-[#181818] to-black/20 w-full bg-cover h-[267px] md:hidden bg-no-repeat"></div>
