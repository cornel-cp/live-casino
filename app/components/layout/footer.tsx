  ...
  return (
    <footer className="">
      <div className="bg-[url(/assets/images/footer-bg1.png)] bg-black bg-no-repeat bg-cover bg-left w-full ">
        <div className="bg-linear-to-r from-red-800/50 to-black/50 w-full bg-cover bg-no-repeat flex justify-center px-10 md:px-20">
          <div className="flex flex-col md:flex-row items-center max-w-6xl w-full py-8 justify-between gap-5">
            ...
            <div className="w-sm md:w-auto">
              <form
                className="flex flex-col md:flex-row gap-7 md:gap-10 z-50 items-center justify-around"
                action={"#"}
              >
                <div className="flex flex-col w-full items-center">
                  <input
                    className="bg-white/20 block w-full max-w-sm md:w-auto min-w-[207px] text-white outline-none nunito mb-2.5 px-2 py-1 border-ra"
                    value={data.name}
                    onChange={(e) => {
                  ...
                  <input
                    className="bg-white/20 w-full max-w-sm md:w-auto min-w-[207px] text-white outline-none px-2 nunito py-1"
                    value={data.email}
                    onChange={(e) => {
                ...
                <button
                  className="w-full max-w-sm md:w-[103px]   px-8 py-2.5 bg-red-800 -skew-x-16"
                  type="submit"
                >
                  <p className="skew-x-16 text-white"> Subscribe</p>
                </button>
              </form>
            </div>
          </div>
