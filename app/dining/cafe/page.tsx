            ...
            <div className="flex gap-10 ml-28 mr-[85px]">
              ...
              <div className="flex-6 nunito">
                <p className="text-white/60 font-extralight text-[14px] pb-5 border-b-2 border-gray-780">
                  ...
                  serves authentic Vietnamese-influenced bánh mì sandwiches,
                  deli & breakfast sandwiches, plus fresh-baked pastries.
                  Patrons can also experience Lee’s Vietnamese Iced Coffee, a
                  full espresso bar and an assortment of outstanding teas and
                  drinks.
                </p>
