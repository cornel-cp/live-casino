            ...
            <div className="flex gap-10">
              <div className="relative">
                ...
                <Image
                  ...
                  height={145}
                />
                <div className="flex justify-between mb-[103.5px] mt-2">
                  <Image
              ...
              <div className="flex-6 nunito">
                <p className="text-white/60 font-extralight text-[14px] pb-5 border-b-2 border-gray-780">
                  ...
                  setting for gathering and socializing. The bar serves finely
                  crafted cocktails, draft beers, wines by the glass, and an
