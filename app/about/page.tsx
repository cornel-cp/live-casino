...
const About = () => {
    ...
    return (
        <Layout>
            <div className="relative w-full h-screen min-h-screen bg-[url(/assets/images/about.jpg)] bg-no-repeat bg-cover bg-center">
            ...
            <div className="mx-6 sm:px-10 md:x-20">
            ...
            <div className="max-w-6xl mx-auto mt-[66px]">
                <Link href={"/dining/sportsBar"}>
                    <div className="flex group -skew-x-16 mb-10 md:mb-5 mx-6 sm:mx-10 md:mx-20">
                        <div className="bg-white/20 justify-center items-center mr-5 md:mr-2 py-5 flex-12 group-hover:bg-white/30 md:flex-4 relative rounded-xs  transition duration-1000">
                            <Image
                        ...
                        <div className="absolute -bottom-5 -right-4 md:hidden rounded-xs">
                            <button className="px-8 py-2.5 bg-red-600" type="submit"><p className="skew-x-16 text-white">Read More</p></button>
                        </div>
                ...
                <Link href={"/dining/cafe"}>
                    <div className="flex -skew-x-16 mb-10 md:mb-5 mx-6 sm:mx-10 md:mx-20 group">
                        <div className="bg-white/20 justify-center items-center mr-5 md:mr-2 py-5 flex-12 md:flex-4 relative rounded-xs group-hover:bg-white/30  transition duration-1000">
                            <Image
                ...
                <Link href={"/dining/parallel"}>
                    <div className="flex -skew-x-16 mb-20 mx-6 sm:mx-10 md:mx-20 group">
                        <div className="bg-white/20 justify-center items-center mr-5 md:mr-2 py-5 flex-12 md:flex-4 relative rounded-xs group-hover:bg-white/30  transition duration-1000">
                            <Image
