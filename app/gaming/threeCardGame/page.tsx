    ...
    <div className="bg-black/50">
      <Layout>
        <div className="px-[85px]">
          <Link href={"/gaming"}>
            <p className="text-white/40 text-[14px] mt-[121px]">
              <span className="text-[14px] font-bold pr-2">&lt;</span>
              Back to <p className="inline">Gaming</p>
            </p>
          </Link>
          ...
          <div className="pt-5 flex flex-col items-center">
            <p className="text-white/40 text-[12px] pb-2.5 w-full">
              GEGA-001277
            </p>
            <p className="text-white/40 text-[12px] pb-[30px]">
            ...
            <BtnElement className="mb-16" color="white" name="LEARN MORE" />
          </div>
          <div className="relative border-2 border-gray-600 flex gap-7 px-10 py-[51px]">
            <p className="absolute top-0 left-22 -translate-[50%] bg-gray-600 text-red-600 text-[28px] font-[400px] px-2">
              HOW TO PLAY
            </p>
          ...
          <div className="flex gap-2 items-start mt-[60px]">
            <div className="relative flex-6 border-2 border-gray-600">
              <p className="absolute top-0 left-40 -translate-[50%] w-[250px] text-[28px] font-[400px] text-red-600 bg-gray-600 text-center">
